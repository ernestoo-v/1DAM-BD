/* Ejercicio: Obtener todos los empleados y sus departamentos, incluyendo aquellos que no tienen departamento asignado:*/
SELECT e.id, e.nombre, d.nombre
FROM empleados e
LEFT JOIN departamentos d ON e.departamento_id = d.id;

/* Ejercicio: Obtener todos los departamentos y sus empleados, incluyendo aquellos departamentos que no tienen empleados:*/
...
SELECT d.nombre, e.genero, COUNT(e.id)
FROM empleados e
LEFT JOIN departamentos d ON e.departamento_id = d.id
